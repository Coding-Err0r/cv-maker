...
Its a simple project to create CV online. Its made with reactjs. It supports both Bangla and English.
...
<img src="images/1 (6).png" alt="Logo" width="800" height="300">
## Tree
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/cv-maker.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/cv-maker.git)
